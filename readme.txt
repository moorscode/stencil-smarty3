=== Stencil: Smarty 3.x Implementation ===
...
If you are familiar with a template engine other than Smarty (or like to use Smarty 2.x) check out the other Implementations:
...
== Installation ==
1. Upload the folder `stencil-smarty3` to the `/wp-content/plugins/` directory or use the WordPress build in plugin-installer
